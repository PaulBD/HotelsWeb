...
using System.Net;
using System.Web;
using api.hotels.co.uk.Configuration;
using Funq;
using ServiceStack;
using ServiceStack.Configuration;
using ServiceStack.Validation;
using hotels.triperoo.co.uk.Configuration;

namespace api.hotels.co.uk
{
    public class Global : HttpApplication
    {
        ...
        public class CmsHost : AppHostBase
        {
            ...
            /// </summary>
            public CmsHost() : base("api.hotels", typeof(CmsHost).Assembly)
            {
